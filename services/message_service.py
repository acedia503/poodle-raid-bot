...
class MessageService:
    ...
    def build_character_info_embed(self, info: dict) -> discord.Embed:
        ...
        embed.add_field(name="캐릭터명", value=str(info.get("character_name") or "-"), inline=False)
        embed.add_field(name="직업", value=str(info.get("job") or "-"), inline=False)
        embed.add_field(name="종족", value=str(info.get("race") or "-"), inline=False)
        embed.add_field(name="서버", value=str(info.get("server") or "-"), inline=False)
        ...
        guild_name = str(info.get("guild_name") or "-")
        embed.add_field(name="칭호/소속", value=guild_name, inline=False)
