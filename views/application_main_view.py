...
class NewApplyButton(discord.ui.Button):
    def __init__(self, view_ref: ApplicationMainView):
        super().__init__(
            label="신규 신청",
...
class SelectCancelButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        await self.view_ref.select_cancel_callback(interaction)
...
class CancelAllButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        await self.view_ref.cancel_all_callback(interaction)
...
class StatusButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        await self.view_ref.status_callback(interaction)
